...
export function TemplatesPanel() {
  ...
  return (
    <div className="absolute left-4 top-20 w-64 bg-zinc-800/90 backdrop-blur-md rounded-2xl p-4 shadow-2xl border border-zinc-700/50 z-50 flex flex-col gap-4">
